      ...
      datasets: [
        {
          ...
          borderWidth,
          borderRadius,
          backgroundColor: `${getCssVariableValue('--p-green-500')}40`,
          borderColor: getCssVariableValue('--p-green-500'),
          datalabels: {
            display: player.total_points_won !== 0,
            color: getCssVariableValue('--p-text-color'),
          },
        },
        {
          label: 'Points Lost',
          ...
          borderWidth,
          borderRadius,
          backgroundColor: `${getCssVariableValue('--p-red-500')}40`,
          borderColor: getCssVariableValue('--p-red-500'),
          datalabels: {
