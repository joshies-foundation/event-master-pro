...
export class SessionService {
  ...
  async createNewGameboardSpaceType(
    gameboardSpace: OmitAutoGeneratedColumns<GameboardSpaceModel>,
  ): Promise<PostgrestSingleResponse<null>> {
    return this.supabase.from(Table.GameboardSpace).insert(gameboardSpace);
  }

  async updateGameboardSpaceType(
    gameboardSpaceId: number,
    partialGameboardSpace: Partial<
      OmitAutoGeneratedColumns<GameboardSpaceModel>
    >,
  ): Promise<PostgrestSingleResponse<null>> {
    return this.supabase
