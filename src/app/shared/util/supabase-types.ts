...
type FunctionReturnType<
  DefaultSchemaTableNameOrOptions extends
    | keyof DefaultSchema['Functions']
    | { schema: keyof DatabaseWithoutInternals },
  FunctionName extends DefaultSchemaTableNameOrOptions extends {
    schema: keyof DatabaseWithoutInternals;
  }
    ? keyof DatabaseWithoutInternals[DefaultSchemaTableNameOrOptions['schema']]['Functions']
    : never = never,
> = DefaultSchemaTableNameOrOptions extends {
  schema: keyof DatabaseWithoutInternals;
}
  ? DatabaseWithoutInternals[DefaultSchemaTableNameOrOptions['schema']]['Functions'][FunctionName] extends {
      Returns: infer R;
    }
    ? R
    : never
  : DefaultSchemaTableNameOrOptions extends keyof DefaultSchema['Functions']
    ? DefaultSchema['Functions'][DefaultSchemaTableNameOrOptions] extends {
        Returns: infer R;
      }
      ? R
      : never
...
export interface EveryoneLosesPercentageOfTheirPointsBasedOnTaskFailureSpecialSpaceEffectData extends EveryoneLosesPercentageOfTheirPointsChaosSpaceDetails {
  taskName: string;
}
